...
def test_first_user_receives_school_admin_automatically(db_session):
    db = db_session
...
def test_second_user_receives_no_automatic_role(db_session):
    db = db_session
    seed_identity(db)
...
def test_first_user_in_new_school_receives_school_admin(db_session):
    db = db_session
    seed_identity(db)
