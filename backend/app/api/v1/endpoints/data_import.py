...
def preview_student_onboarding(
    ...
    """
    Validate student import file and return row-level preview, duplicate candidates, and reference errors.
    """
...
def commit_student_onboarding(
    ...
    """
    Atomically commit validated student onboarding batch with single-transaction rollback on failure.
    """
    content = file.file.read()
    filename = file.filename or "upload.csv"
